...
include(joinpath(dir, "Implicit_competition_for_herbivores.jl"))
...
avg_shannon, avg_bbp, richness_sim, alive_preds, mean_tl, mean_sp, Threads, NaNs = run_simulations(sigma, epsilon, alfa, sigma_comp, assymetry)

####################################################################
println("Epsilon: ", round(epsilon, digits = 2), ", Sigma: ", round(sigma, digits = 3), ", Alpha: ", round(alpha, digits = 2), ", Sigma_comp: ", round(sigma_comp, digits = 2), ", Assymetry: ", round(assymetry, digits = 2))
