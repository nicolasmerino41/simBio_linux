...
a, b, richness_sim, alive_preds, mean_tl, mean_sp, NaNs = run_simulation(sigma, epsilon, alfa, sigma_comp, assymetry)
avg_shannon = log(ℯ, 256) - a
avg_bbp = 3.5 - b
####################################################################
...
println("The inverse average_shannon was: ", round(avg_shannon, digits = 2))
println("The inverse biomass_distribution was: ", round(avg_bbp, digits = 2))
